"""
Centralized exceptions for Timetrace.
...
class TimetraceError(Exception):
    """Base exception for all Timetrace errors."""
    pass


class CassetteError(TimetraceError):
...
class ReplayMismatchError(TimetraceError):
    """
...
class ConfigurationError(TimetraceError):
    """Raised when there's an invalid configuration."""
    pass


class PluginError(TimetraceError):
...
class PluginNotFoundError(PluginError):
    ...
    def __init__(self, plugin_name: str):
        ...
        super().__init__(
            ...
            f"Make sure it's installed: pip install timetrace[{plugin_name}]"
        )
