"""
TraceConfig - Central configuration for Timetrace.
...
from timetrace.constants import (
    CapturePolicy,
    Defaults,
    EnvVars,
    TraceMode,
)
from timetrace.exceptions import ConfigurationError
