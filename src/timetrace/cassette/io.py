...
from timetrace.cassette.naming import cassette_filename, get_date_directory
from timetrace.constants import SCHEMA_VERSION, EventType
from timetrace.exceptions import CassetteNotFoundError, CassetteSchemaError
from timetrace.types import (
    AppliedPolicies,
    BodySnapshot,
    CaptureStats,
    Cassette,
...
if TYPE_CHECKING:
    ...
    from timetrace.session import TraceSession
...
def read_cassette(path: str) -> Cassette:
    ...
    """
    from timetrace.constants import SUPPORTED_SCHEMA_VERSIONS
...
def _session_meta_to_dict(meta: SessionMeta) -> dict[str, Any]:
    ...
    return {
        ...
        "timetrace_version": meta.timetrace_version,
...
def _dict_to_session_meta(data: dict[str, Any]) -> SessionMeta:
    ...
    return SessionMeta(
        ...
        timetrace_version=data.get("timetrace_version", ""),
