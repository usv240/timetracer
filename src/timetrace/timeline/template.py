...
from timetrace.timeline.generator import TimelineData
...
<head>
    ...
    <title>Timetrace Timeline - {data.title}</title>
    <style>
{_get_css()}
    </style>
</head>
<body>
    <div class="container">
        ...
        <footer>
            <p>Generated by <strong>Timetrace</strong> v0.1.0</p>
        </footer>
    </div>
