...
def enable_pymongo() -> None:
    """
    Enable PyMongo/MongoDB interception for recording and replay.

    This patches PyMongo collection methods to capture database operations.
    Call disable_pymongo() to restore original behavior.
    """
    global _enabled
    ...
    try:
        ...
        raise ImportError(
            "pymongo is required for the pymongo plugin. "
            "Install it with: pip install pymongo"
        )

    # Store original methods
    _original_methods["find"] = Collection.find
    _original_methods["find_one"] = Collection.find_one
    _original_methods["insert_one"] = Collection.insert_one
    _original_methods["insert_many"] = Collection.insert_many
    _original_methods["update_one"] = Collection.update_one
    _original_methods["update_many"] = Collection.update_many
    _original_methods["replace_one"] = Collection.replace_one
    _original_methods["delete_one"] = Collection.delete_one
    _original_methods["delete_many"] = Collection.delete_many
    _original_methods["count_documents"] = Collection.count_documents
    _original_methods["aggregate"] = Collection.aggregate

    # Patch methods
    Collection.find = _patched_find
    Collection.find_one = _patched_find_one
    Collection.insert_one = _patched_insert_one
    Collection.insert_many = _patched_insert_many
    Collection.update_one = _patched_update_one
    Collection.update_many = _patched_update_many
    Collection.replace_one = _patched_replace_one
    Collection.delete_one = _patched_delete_one
    Collection.delete_many = _patched_delete_many
...
def disable_pymongo() -> None:
    """
    Disable PyMongo/MongoDB interception and restore original behavior.
    """
    global _enabled
    ...
    if "find" in _original_methods:
        Collection.find = _original_methods["find"]
    if "find_one" in _original_methods:
        Collection.find_one = _original_methods["find_one"]
    if "insert_one" in _original_methods:
        Collection.insert_one = _original_methods["insert_one"]
    if "insert_many" in _original_methods:
        Collection.insert_many = _original_methods["insert_many"]
    if "update_one" in _original_methods:
        Collection.update_one = _original_methods["update_one"]
    if "update_many" in _original_methods:
        Collection.update_many = _original_methods["update_many"]
    if "replace_one" in _original_methods:
        Collection.replace_one = _original_methods["replace_one"]
    if "delete_one" in _original_methods:
        Collection.delete_one = _original_methods["delete_one"]
    if "delete_many" in _original_methods:
        Collection.delete_many = _original_methods["delete_many"]
    if "count_documents" in _original_methods:
        Collection.count_documents = _original_methods["count_documents"]
    if "aggregate" in _original_methods:
        Collection.aggregate = _original_methods["aggregate"]
...
def _patched_find(
    ...
    **kwargs: Any,
    ...
    """Patched find method - note: find() returns a cursor."""
    # Find returns a cursor, we record it but actual query happens on iteration
...
def _patched_find_one(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["find_one"](self, filter, *args, **kwargs)
        return result
...
def _patched_insert_one(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["insert_one"](self, document, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_insert_many(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["insert_many"](self, documents, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_update_one(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["update_one"](self, filter, update, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_update_many(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["update_many"](self, filter, update, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_replace_one(
    ...
    **kwargs: Any,
    ...
    """Patched replace_one method."""
    start_time = time.perf_counter()
    error_info = None
    result = None

    try:
        result = _original_methods["replace_one"](self, filter, replacement, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_delete_one(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["delete_one"](self, filter, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_delete_many(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["delete_many"](self, filter, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
...
def _patched_count_documents(
    ...
    **kwargs: Any,
    ...
    try:
        result = _original_methods["count_documents"](self, filter, *args, **kwargs)
        return result
    except Exception as e:
        error_info = (type(e).__name__, str(e))
        raise
